...
def parse_train_args():
    ...
    parser.add_argument('--save_model', type=str, default = 'workdir/EquiScore/2025-09-28-13-11-33/save_best_model_0.pt',help='model for test or restart training')
    ...
    parser.add_argument('--batch_size', type=int, default=3, help='Batch size on each gpu')
    ...
    parser.add_argument('--dropout_rate', type=float, default=0.2, help='dropout_rate in EquiScore')
    parser.add_argument('--attention_dropout_rate', type=float, default=0.2, help='dropout_rate in Attention module')
