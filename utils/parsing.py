...
def parse_train_args():
    ...
    parser.add_argument('--data_set', type=str, default='PNA_keys.csv', help='Path to training set file')
    parser.add_argument('--save_dir', type=str, default='workdir', help='Folder in which to save model and logs')
    parser.add_argument('--local_rank', type=int, default = -1,help='local rank for DistributedDataParallel')
    parser.add_argument('--save_model', type=str, default = 'workdir/EquiScore/2025-10-09-22-33-13/save_best_model_0.pt',help='model for test or restart training')
    parser.add_argument('--lmdb_cache', type=str, default='lmdbs/DGL2rdock', help='Folder containing trainging data in lmdb format')
    ...
    # Dataset
    parser.add_argument('--train_keys', type=str, default='trainData.pkl', help='Path of file defining the split')
    parser.add_argument('--val_keys', type=str, default='trainData.pkl', help='Path of file defining the split')
    parser.add_argument('--test_keys', type=str, default='testData.pkl', help='Path of file defining the split')
    ...
    parser.add_argument('--mse_weight', type=int, default=0.8, help='mse_weight')
    parser.add_argument('--pcc_weight', type=int, default=0.00, help='pcc_weight')
    parser.add_argument('--spcc_weight', type=int, default=0.00, help='spcc_weight')
    parser.add_argument('--gan_weight', type=int, default=0.2, help='gan_weight')
    ...
    parser.add_argument('--batch_size', type=int, default=8, help='Batch size on each gpu')
    ...
    parser.add_argument('--pct_start', type=float, default=0.1, help='OneCycleLR parameter')
    ...
    parser.add_argument('--threshold', type=float, default=8, help='Radius cutoff for geometric diatance based graph')
    parser.add_argument('--n_FC_layer', type=int, default=3, help='Number of linear layers')
    parser.add_argument('--d_FC_layer', type=int, default=128, help='dims of linear layers')
    ...
    parser.add_argument('--ffn_size', type=int, default=256, help='dims of FFN layers in EquiScore')
    parser.add_argument('--dropout_rate', type=float, default=0.3, help='dropout_rate in EquiScore')
    parser.add_argument('--attention_dropout_rate', type=float, default=0.3, help='dropout_rate in Attention module')
    parser.add_argument('--head_size', type=int, default=4, help='number of attention heads in EquiScore')
    ...
    parser.add_argument('--rel_pos_bias', action='store_true', default=True, help=' shortest path distance informations')
    parser.add_argument('--equi', action='store_true', default=False, help='add equi info')
    parser.add_argument('--lap_pos_enc', action='store_true', default=False, help='laplace position infomations')
    parser.add_argument('--ligandonly', action='store_true', default=False, help='only ligand infomations')
    parser.add_argument('--crossatt', action='store_true', default=False, help='cross infomations')
    parser.add_argument('--use_gan', action='store_true', default=False, help='use_gan')
    parser.add_argument('--onlytest', action='store_true', default=False, help='use_gan')
    parser.add_argument('--draw', action='store_true', default=False, help='use_gan')
    parser.add_argument('--contrastive', action='store_true', default=False, help='use_contrastive')
    parser.add_argument('--test_step', type=int, default=20, help='test every n steps')
    parser.add_argument('--useMultiModel', action='store_true', default=False, help='useMultiModel')
    parser.add_argument('--image_network', action='store_true', default=False, help='use image_network')
    parser.add_argument('--share_weights', action='store_true', default=False, help='use share_weights')
    parser.add_argument('--noatom_feat', action='store_true', default=False, help='noatom_feat')
    parser.add_argument('--nores_feat', action='store_true', default=False, help='nores_feat')
    parser.add_argument('--out_cam_dir', type=str, default="visiable5", help='output directory for CAM results')
    parser.add_argument('--image_dir', type=str, default='./data/mydata/nobond_pymol_views', help='Folder containing images for protein and rna residues')
    parser.add_argument('--image_frozen', action='store_true', default=False, help='freeze image network weights or not')
    parser.add_argument('--attn_dump_dir', type=str, default='./attn', help='Folder to dump attention weights for debugging')
    parser.add_argument('--dump_attn', action='store_true', default=False, help='Whether to write attention weights to disk for debugging')
